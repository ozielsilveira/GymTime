...
public class BookingServiceTests : IDisposable
{
 ...
 .ReturnsAsync((GymMember?)null);
    ...
    [Fact]
    public async Task BookClassAsync_DuplicateBooking_ReturnsErrorMessage()
    {
     // Arrange
        var gymMemberId = Guid.NewGuid();
        var classSessionId = Guid.NewGuid();
   ...
   StartTime = new TimeOnly(10, 0),
      ...
      Schedule = DateTime.UtcNow.AddDays(1),
       ...
       Bookings = []
        ...
        // Create an existing booking for the same member and session
    ...
    await _context.SaveChangesAsync();
      ...
      _mockGymMemberRepo.Setup(x => x.GetByIdAsync(gymMemberId))
        ...
        // Assert
    Assert.Equal("You already have a booking for this class session.", result);
    }
