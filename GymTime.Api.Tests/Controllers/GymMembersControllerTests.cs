...
public class GymMembersControllerTests
{
    ...
    {
        public IEnumerable<GymMemberDto> AllReturn { get; set; } = [];
        ...
        public Task<GymMemberDto?> GetByIdAsync(Guid id)
        {
            LastGetById = id;
            return Task.FromResult(ByIdReturn);
        }
        public Task<GymMemberDto> CreateAsync(CreateGymMemberRequest request)
        {
            LastCreateRequest = request;
            return Task.FromResult(CreateReturn!);
        }
        public Task<bool> UpdateAsync(Guid id, UpdateGymMemberRequest request)
        {
            LastUpdateId = id;
    ...
    public async Task GetAll_ReturnsOkWithItems()
    {
        ...
        {
            AllReturn = [new GymMemberDto { Id = Guid.NewGuid(), Name = "John", PlanType = Domain.Enums.PlanType.Monthly }]
        };
    ...
    {
        var fake = new FakeGymMemberService();
        var dto = new GymMemberDto { Id = Guid.NewGuid(), Name = "Ana", PlanType = Domain.Enums.PlanType.Annual };
        fake.ByIdReturn = dto;
        var controller = new GymMemberController(fake);
    ...
    {
        var fake = new FakeGymMemberService();
        var created = new GymMemberDto { Id = Guid.NewGuid(), Name = "Paulo", PlanType = Domain.Enums.PlanType.Quarterly };
        fake.CreateReturn = created;
        var controller = new GymMemberController(fake);

        var request = new CreateGymMemberRequest { Name = "Paulo", PlanType = Domain.Enums.PlanType.Quarterly };
    ...
    public async Task Update_ReturnsNoContent_WhenUpdated()
    {
        ...
        var id = Guid.NewGuid();
        var request = new UpdateGymMemberRequest { Name = "Updated", PlanType = Domain.Enums.PlanType.Monthly };
    ...
    public async Task Update_ReturnsNotFound_WhenMissing()
    {
        ...
        var result = await controller.Update(Guid.NewGuid(), new UpdateGymMemberRequest { Name = "x", PlanType = Domain.Enums.PlanType.Monthly });
